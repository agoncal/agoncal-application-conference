...
export class TalkApi {
    ...
    constructor(protected http: Http, @Optional() @Inject(BASE_PATH) basePath: string, @Optional() configuration: Configuration) {
        ...
        this.basePath += '/conference-talk/api';
     ...
     * 
     * @param body Talk to be created
     */
    public add(body: models.Talk, extraHttpRequestParams?: any): Observable<{}> {
    ...
    public allTalks(page?: number, extraHttpRequestParams?: any): Observable<Array<models.Talk>> {
        return this.allTalksWithHttpInfo(page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param body Talk to be created
     */
    public addWithHttpInfo(body: models.Talk, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param page 
     */
    public allTalksWithHttpInfo(page?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/talks`;
