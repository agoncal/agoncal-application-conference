...
The application consists of several Microservices and a Web-Application managing a conference. It is inspired by the one used in the https://github.com/microprofile/microprofile-conference[Micro Profile samples].

= Architecture

* Venue service. Manage the venue description with rooms and halls
* Speaker service. Manage speakers, Bios, etc
* Talk service. Manage the talks of the conference
* Schedule Service.  Service to manage talks schedule
* Voting service. Vote for the your favorite talk
